...
test_init_core_install() {
  ...
  assert_file_exists "$target/.claude/helpers/checkpoint.cjs"
  assert_file_exists "$target/.claude/helpers/archive-context.cjs"
  assert_file_exists "$target/.claude/helpers/restore-context.cjs"
