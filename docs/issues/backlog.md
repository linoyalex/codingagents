...
| 8 | [ISS-023](tickets/ISS-023.md) | P2 — Medium | Feature | — | Strengthen architecture decision skill with wiring diagrams, evidence rules, and observability naming |
| 9 | [ISS-006](tickets/ISS-006.md) | P2 — Medium | Feature | — | Add `review-history.md` to capture cross-review rework in feature artifacts |
| 10 | [ISS-025](tickets/ISS-025.md) | P2 — Medium | Feature | — | Add adversarial self-review checkpoint to Phase 5 verification |
| 11 | [ISS-015](tickets/ISS-015.md) | P2 — Medium | Feature | — | Add first-class post-implementation QA verification stage |
| 12 | [ISS-012](tickets/ISS-012.md) | P2 — Medium | Feature | — | Add stage-matched Codex reviews and iterative feedback resolution through the pipeline |
| 13 | [ISS-019](tickets/ISS-019.md) | P2 — Medium | Architecture | — | Add `allowed-tools` frontmatter to read-only skills |
| 14 | [ISS-017](tickets/ISS-017.md) | P2 — Medium | Feature | — | Add stop-conditions footer to high-stakes skills |
| 15 | [ISS-007](tickets/ISS-007.md) | P2 — Medium | Feature | — | Force upgrade and clean reinstall with backup support |
| 16 | [ISS-008](tickets/ISS-008.md) | P2 — Medium | Feature | — | Sync project CLAUDE.md with reference docs/CLAUDE.md on init/upgrade |
| 17 | [ISS-011](tickets/ISS-011.md) | P3 — Low | Feature | — | Add shell script wrappers for Codex reviewer workflows |
| 18 | [ISS-016](tickets/ISS-016.md) | P3 — Low | Architecture | — | Document intentional divergence from Anthropic slash command guidance |
| 19 | [ISS-018](tickets/ISS-018.md) | P3 — Low | Architecture | — | Standardize skill naming on gerund form |
| 20 | [ISS-020](tickets/ISS-020.md) | P3 — Low | Architecture | — | Prefix generated PRD filenames with the feature slug |
| 21 | [ISS-021](tickets/ISS-021.md) | P3 — Low | Feature | — | Add first-class command entry points for Codex reviewer prompts |
...
- **Wave 4 — Test & review layer hardening (4–9):** Closes the two biggest failure patterns (missing integration tests, reviewer rubber-stamping), then strengthens architecture and review artifacts. ISS-022 and ISS-024 are P1; the rest reinforce them.
- **Wave 5 — Verification & QA loop (10–12):** Developer adversarial self-review, post-implementation QA stage, and stage-matched Codex reviews. Defense-in-depth after Wave 4 hardens the primary gates.
- **Wave 6 — Skill polish (13–14):** `allowed-tools` frontmatter and stop-conditions footers. Small, scoped skill improvements.
- **Wave 7 — Install ergonomics (15–16):** Force upgrade + clean reinstall, then project CLAUDE.md sync. Independent of pipeline-correctness work above.
- **Wave 8 — Documentation polish (17–21):** Low-priority DX and documentation items. Defer until a real pain point forces them.
...
- **ISS-023 at Order 8** adds architecture rigor (wiring diagrams, evidence rules). Valuable but the gaps are currently caught by Codex review, so less urgent than the test/review fixes above.
- **ISS-025 at Order 10** is the developer-side counterpart to ISS-024. Less critical once ISS-024 hardens the reviewer, but provides defense-in-depth.
- **ISS-006 has no hard dependency but is sequenced inside Wave 4** because ISS-012 (stage-matched Codex reviews, Order 12) benefits substantially from having review-history already in place.
